 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ret" type="{urn:api3}soapClientInfo" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetClientInfoResponse {
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2015-10-25T05:29:34+06:00", comments = "JAXB RI v2.2.11")
    protected List<SoapClientInfo> ret;
     ...
     */
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2015-10-25T05:29:34+06:00", comments = "JAXB RI v2.2.11")
    public List<SoapClientInfo> getRet() {
        if (ret == null) {
            ret = new ArrayList<SoapClientInfo>();
        }
        return this.ret;
    }
