 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ret" type="{urn:api3}soapLicense" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetLicenseResponse {
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2015-10-25T05:29:34+06:00", comments = "JAXB RI v2.2.11")
    protected List<SoapLicense> ret;
     ...
     */
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2015-10-25T05:29:34+06:00", comments = "JAXB RI v2.2.11")
    public List<SoapLicense> getRet() {
        if (ret == null) {
            ret = new ArrayList<SoapLicense>();
        }
        return this.ret;
    }
