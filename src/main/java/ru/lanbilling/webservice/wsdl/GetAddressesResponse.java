 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ret" type="{urn:api3}soapAddressBrief" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetAddressesResponse {
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2015-10-25T05:29:34+06:00", comments = "JAXB RI v2.2.11")
    protected List<SoapAddressBrief> ret;
     ...
     */
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2015-10-25T05:29:34+06:00", comments = "JAXB RI v2.2.11")
    public List<SoapAddressBrief> getRet() {
        if (ret == null) {
            ret = new ArrayList<SoapAddressBrief>();
        }
        return this.ret;
    }
